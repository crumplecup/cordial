...
use super::types::{
    AntipatternRuleId, build_workspace_antipatterns_summary,
    build_workspace_version_in_member_summary,
};
...
fn antipattern_rows(findings: &[&dyn Finding]) -> Vec<AntipatternRow> {
    findings
        .iter()
