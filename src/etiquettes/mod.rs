...
//! | `tracing` | `tracing` | Are functions instrumented with the recipe for their role, is a subscriber installed, and are leftover stdio macros (`println!`/`print!`/`dbg!`) gone? |
