...
use super::types::{GlobImportFinding, GlobImportRule, GlobImportRuleId};

use tracing::instrument;

/// Converts glob-import markers into open findings.
#[derive(Debug, Default, Clone, Copy)]
pub struct GlobImportAssessor;

impl GlobImportAssessor {
    pub const ID: &'static str = "glob-import-assessor";
}

impl Assessor for GlobImportAssessor {
    ...
    fn assess(
        ...
        for marker in markers {
            ...
            let Some(rule_id) = GlobImportRuleId::from_attr(rule_value) else {
                continue;
            };
            let context = node
                .attr("context")
            ...
            findings.push(Box::new(GlobImportFinding {
                rule: GlobImportRule::new(rule_id),
