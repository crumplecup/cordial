...
use super::types::{InlineTestFinding, InlineTestRule, InlineTestRuleId};

use tracing::instrument;

/// Converts inline-test markers into open findings.
#[derive(Debug, Default, Clone, Copy)]
pub struct InlineTestAssessor;

impl InlineTestAssessor {
    pub const ID: &'static str = "inline-test-assessor";
}

impl Assessor for InlineTestAssessor {
    ...
    fn assess(
        ...
        for marker in markers {
            ...
            let Some(rule_id) = InlineTestRuleId::from_attr(rule_value) else {
                continue;
            };
            let context = node
                .attr("context")
            ...
            findings.push(Box::new(InlineTestFinding {
                rule: InlineTestRule::new(rule_id),
