...
use super::scan::scan_crate_pageantry;

use tracing::instrument;

/// Materializes pageantry expression nodes in the IR graph.
#[derive(Debug, Default, Clone, Copy)]
pub struct PageantryInventoryEnricher;

impl PageantryInventoryEnricher {
    pub const ID: &'static str = "pageantry-inventory";
}

impl IrEnricher for PageantryInventoryEnricher {
